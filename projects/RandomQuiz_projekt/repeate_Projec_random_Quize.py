...
for quizNum in range(35):
    quizFile = open(OUTPUT_DIR / f'capital_quiz_{quizNum+1}.txt', "w")
    answerKeyFile = open(OUTPUT_DIR / f'capital_quiz_answers{quizNum+1}.txt', "w")

    quizFile.write('Name:\n\nDate:\n\nPeriod:\n\n')
    quizFile.write((' ' * 20) + f"State Capital Quiz (Form {quizNum +1})")
    quizFile.write('\n\n')

    states: list[str] = list(capitals.keys())
